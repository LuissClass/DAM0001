...
public class ColorsToText implements IColorsToText {
    ...
    @Override
    public String asciiToDec(String textAscii) { // TODO, cuidado cuando se le ponga de parametro algo que no sea una letra
        textDec = "";
    ...
    public String decToBin(String textDec) {
        int numInt;
        String numStr = "";
        textBin = "";
    ...
    @Override
    public String binToHex(String textBin) {
        String binStr = "";
        int numInt = 0;
        char numChar = ' ';
        textHex = "";
    ...
    @Override
    public String hexToColor(String textHex) {
        colors = "";
        String hex = textHex;
    ...
    public static void main(String[] args) {
        ColorsToText Test = new ColorsToText();

        System.out.println("SUPER PRUEBA");
        System.out.println(Test.asciiToDec("PENE"));
        System.out.println(Test.decToBin("80697869"));
        System.out.println(Test.binToHex("110000100101101110100101"));
        System.out.println(Test.hexToColor("C25BA5"));

        System.out.println("MEGAPRUEBA");
        System.out.println(Test.hexToColor(Test.binToHex(Test.decToBin(Test.asciiToDec("SUPERPENE")))));
