...
public class TecladoGrafico {
	...
	/**
	 * Este metodo muestra una ventana grafica con el texto recibido como
	 * parametro y pide un numero entero por teclado. 
	 * @param texto  - Este texto sera mostrado en la ventana grafica
	 * @return    Devolvera el numero entero leido de teclado
	 * @throws No lanza ninguna excepcion
	 */
